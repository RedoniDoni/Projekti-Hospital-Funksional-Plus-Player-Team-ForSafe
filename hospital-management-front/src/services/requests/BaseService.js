import api from "./axiosInstance"; // NOT { api }, just api without {}
...
export class BaseService {
  ...
  constructor(requestMapping) {
    this.client = api; // use api instead of axiosInstance
  ...
  validateOnCreate(data) {
    return this.client.post(`${this.requestMapping}/validate`, data);
  }

  validateOnUpdate(data) {
    return this.client.put(`${this.requestMapping}/validate`, data);
  }
}

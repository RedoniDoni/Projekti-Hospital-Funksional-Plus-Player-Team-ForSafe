...
import ShowLecturer from '../pages/entity/Ligjeruesi/ShowLigjeruesi';
...
import ShowLigjerata from '../pages/entity/Ligjerata/ShowLigjerata';

//import CreateLecture from '../pages/entity/ligjerata/CreateLigjerata';
import CreateLecturer from '../pages/entity/Ligjeruesi/CreateLigjeruesi';
import CreateLigjerata from '../pages/entity/Ligjerata/CreateLigjerata';

import CreatePlayer from '../pages/entity/Player/CreatePlayer';
import ShowPlayer from '../pages/entity/Player/ShowPlayer';
import CreateTeam from '../pages/entity/Team/CreateTeam';
import ShowTeam from '../pages/entity/Team/ShowTeam';
...
export const AdminRoutes = [
  ...
  { path: "/lecturer/show", element: <ShowLecturer /> },
  { path: "/lecturer/add", element: <CreateLecturer /> },
  { path: "/ligjerata/show", element: <ShowLigjerata /> },
  { path: "/ligjerata/add", element: <CreateLigjerata /> },
  //{ path: "/ligjerusi/add", element: <CreateLigjE /> },

  { path: "/player/show", element: <ShowPlayer /> },
  { path: "/player/add", element: <CreatePlayer /> },
  { path: "/team/show", element: <ShowTeam /> },
  { path: "/team/add", element: <CreateTeam /> },
